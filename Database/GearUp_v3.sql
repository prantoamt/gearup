...
-- Table `GearUp`.`main`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GearUp`.`main` ;

CREATE TABLE IF NOT EXISTS `GearUp`.`main` (
...
-- -----------------------------------------------------
-- Table `GearUp`.`Customer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GearUp`.`Customer` ;

CREATE TABLE IF NOT EXISTS `GearUp`.`Customer` (
  `master_uId` INT NOT NULL,
  `fullName` VARCHAR(45) NULL,
  `password` VARCHAR(45) NOT NULL,
  `phoneNumber` VARCHAR(45) NOT NULL,
...
USE `GearUp`$$
DROP TRIGGER IF EXISTS `GearUp`.`mainInsert` $$
USE `GearUp`$$
CREATE TRIGGER mainInsert
AFTER INSERT ON `main`
FOR EACH ROW
BEGIN
	IF (main.sType = 'Plumber') 
    THEN INSERT INTO Plumber (fullname, password, phoneNumber, email, Address) VALUES (main.fullname, main.password, main.phoneNumber, main.email, main.Address); 
	ELSE IF (main.sType = Mechanic) 
    THEN INSERT INTO Mechanic (fullname, password, phoneNumber, email, Address) VALUES (main.fullname, main.password, main.phoneNumber, main.email, main.Address); 
    ELSE IF (main.sType = 'Customer') 
    THEN INSERT INTO Customer (fullname, password, phoneNumber, email, Address) VALUES (main.fullname, main.password, main.phoneNumber, main.email, main.Address);
	ELSE IF (main.sType = 'Electrician') 
    THEN INSERT INTO Electrician (fullname, password, phoneNumber, email, Address) VALUES (main.fullname, main.password, main.phoneNumber, main.email, main.Address);
	ELSE IF (main.sType = 'Others') 
    THEN INSERT INTO Others (fullname, password, phoneNumber, email, Address) VALUES (main.fullname, main.password, main.phoneNumber, main.email, main.Address);
...
USE `GearUp`$$
CREATE TRIGGER chatSession AFTER INSERT ON `request`
  FOR EACH ROW
  BEGIN
	IF NEW.uId1 = uId2
    THEN INSERT INTO chatSession (uId1,uId2) VALUES (NEW.uId1,NEW.uId2);
	END IF; 
END;$$
